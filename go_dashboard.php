    ...
    <div class="card">
        <div class="card-header">
         ...
         $closed=0;
           ...
           $result= mysqli_query($conn, "SELECT * FROM complaint WHERE cat='$catid' AND status='Approved'");
           $approved= mysqli_num_rows($result);
            $result= mysqli_query($conn, "SELECT * FROM complaint WHERE cat='$catid' AND status='Forwarded'");
           $forward= mysqli_num_rows($result);
                $result= mysqli_query($conn, "SELECT * FROM complaint WHERE cat='$catid' AND status='Completed'");
           $closed= mysqli_num_rows($result);
             $result= mysqli_query($conn, "SELECT * FROM complaint WHERE cat='$catid' AND status='Rejected'");
        ...
        <div class="card-body">
            <table class="table table-striped table-hover table-bordered">
                ...
                <tr>
                    <td>New Complaint <a href="newcomp.php"><i class="fas fa-eye"></i> View</a></td>
                    <td><?php print $new; ?></td>
                </tr>
                   <tr>
            ...
            <table id="dataTable" class="table table-striped table-hover table-bordered table-responsive-lg text-center">
                ...
                <tbody>
                    ...
                    $result= mysqli_query($conn, "SELECT * FROM complaint WHERE cat='$catid'");
