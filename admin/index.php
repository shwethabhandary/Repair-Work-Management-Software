    ...
    <div class="card">
        ...
        $new=0;
         ...
         $closed=0;
           ...
           $result= mysqli_query($conn, "SELECT * FROM complaint WHERE status='Forwarded'");
           $forward= mysqli_num_rows($result);
            $result= mysqli_query($conn, "SELECT * FROM complaint WHERE status='Approved'");
           ...
           $closed= mysqli_num_rows($result);
                 $result= mysqli_query($conn, "SELECT * FROM complaint WHERE status='Rejected'");
