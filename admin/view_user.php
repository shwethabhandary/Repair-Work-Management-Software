      ...
      <a class="nav-link" href="index.php">Dashboard </a>
       ...
       <li class="nav-item dropdown ">
        ...
        <div class="dropdown-menu bg-dark" aria-labelledby="navbarDropdown">
            ...
            <a class="dropdown-item text-white" href="#">View Users</a>
   ...
   if(mysqli_affected_rows($conn)>0)
{
  ...
  <strong>Successful!</strong> User Deleted Successfully.
...
else
{
  ...
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    <span aria-hidden="true">&times;</span>
        ...
        <div class="card-body">
            <table id="dataTable" class="table table-bordered table-striped table-hover table-responsive-lg text-center">
                ...
                $x=$row['id'];
                $rr= mysqli_query($conn, "SELECT * FROM dept WHERE head='$x'");
    ...
    <td><form method="post" action=""><button type="submit" class="btn btn-danger" value="'.$row['id'].'" name="del_user">Delete</button></form></td>
