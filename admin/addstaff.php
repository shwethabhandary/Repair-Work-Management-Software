      ...
      <a class="nav-link" href="index.php">Dashboard </a>
       ...
       <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu bg-dark" aria-labelledby="navbarDropdown">
            ...
            <a class="dropdown-item text-white" href="#">Add Staff</a>
...
$query="INSERT INTO staff(name,email,dept,pass,auth) VALUES ('$name','$email','$dept','$pass','$type')";
...
if(mysqli_affected_rows($conn)>0)
{
    ...
    if($type=="electrical")
    {
        mysqli_query($conn, "UPDATE category SET head='$id' WHERE name='Electrical'");
    }
    else 
         if($type=="networking")
    {
        mysqli_query($conn, "UPDATE category SET head='$id' WHERE name='Networking'");
    }
     else 
         if($type=="general")
    {
        mysqli_query($conn, "UPDATE category SET head='$id' WHERE name='General'");
    }
    echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
  <strong>Successful!</strong> Staff added Successfully.
        ...
        <div class="card-body">
            <form action="" method="post">
                   ...
                   <select class="custom-select" name="type">
                        <option value="">-Select-</option>
                          <option value="staff">Staff</option>
                           <option value="electrical">GO (Electrical)</option>
                                 <option value="networking">GO (Networking)</option>
                                   <option value="general">GO (General)</option>
                ...
                <div class="form-group text-center">
                    <button class="btn btn-outline-success" name="add_s">Add</button>
                </div>
