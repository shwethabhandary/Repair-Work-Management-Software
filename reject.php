...
if(isset($_SESSION['officer_id']))
{
    $id= $_SESSION['officer_id'];
     ...
     $catid=$row['catid'];
     $session_query="SELECT * FROM complaint,estimation WHERE complaint.id=estimation.compid AND cat='$catid' AND status='Rejected'";
...
} else if(isset($_SESSION['hod']))
{
     ...
     $deptid=$row['deptid'];
     $deptname=$row['name'];
      $session_query="SELECT * FROM complaint,estimation WHERE complaint.id=estimation.compid AND dept='$deptid' AND status='Rejected'";
}
else {
 ...
 <header>
  ...
  <li class="nav-item  pr-3">
      ...
      if(isset($_SESSION['officer_id']))
     {
         echo ' '
          . '   <a class="dropdown-item text-white" href="regcomp.php">Register Complaint</a>
             <a class="dropdown-item text-white" href="viewstatus.php">View Status</a><a class="dropdown-item text-white" href="newcomp.php">New Complaint</a>';
     }
        if(isset($_SESSION['principal']))
     {
     ...
     ?>
           ...
           <a class="dropdown-item text-white" href="#">Rejected Complaint</a>
