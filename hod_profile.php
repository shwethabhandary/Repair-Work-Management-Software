          ...
          <form method="post" action="">
              <div class="form-group">
                  <div class="input-group">
                      ...
                      <input type="text" class="form-control" value="<?php echo "CECHOD".sprintf("%03d",$id);?>" placeholder="Staff ID"  readonly/>
                  </div>
              </div>
                 <div class="form-group">
                  <div class="input-group">
                      ...
                      <input type="text" class="form-control" value="<?php echo $deptname;?>" placeholder="Department"  readonly/>
                  </div>
              </div>
                            <div class="form-group">
                  <div class="input-group">
