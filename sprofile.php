    ...
    <span aria-hidden="true">&times;</span>
        ...
        <div class="card-body">
            <table class="table table-striped table-hover table-bordered">
                <tr>
                    <td>Staff ID</td>
                    <td><?php echo "CEC".sprintf("%03d",$id);?></td>
                </tr>
                <tr>
                    <td>Name</td>
              ...
              <div class="form-group">
                  <div class="input-group">
                       <div class="input-group-prepend">
                            <span class="input-group-text"><i class="fas fa-id-badge"></i></i></span>
                        </div>
                      <input type="text" class="form-control" value="<?php echo "CEC".sprintf("%03d",$id);?>" placeholder="Staff ID"  readonly/>
                  </div>
              </div>
                            <div class="form-group">
                  <div class="input-group">
                      ...
                      <input type="text" class="form-control" placeholder="Name" value="<?php print $name; ?>" name="uname" required/>
                  </div>
              </div>
                       <div class="form-group">
                  <div class="input-group">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="text-center">
                    <button type="submit" class="btn btn-success" disabled id="cpass" name="passupdate">Change</button>
                </div>
              </form>
            </div>
