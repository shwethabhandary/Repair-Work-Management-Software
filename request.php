              ...
              <th>
                ...
                echo $aa['name'].'
                        ...
                        <td>';
                           ...
                           echo '<button type="submit" class="btn btn-success" value="'.$row['id'].'" name="approve_p">Approve</button>';
      ...
      <div class="modal-body">
          <form method="post" action="">
              ...
              <div class="form-group text-center">
                  <button type="submit" name="reject_p" class="btn btn-outline-danger">Reject</button>
              </div>
          </form>
      </div>
